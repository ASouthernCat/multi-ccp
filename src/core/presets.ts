...
export const PROFILE_PRESETS: BuiltinProfilePreset[] = [
  {
    ...
    description: "Anthropic-compatible endpoint using Claude Code default models.",
  ...
  },
  {
    ...
    description: "DeepSeek endpoint with long-context main models and flash subagent.",
  ...
  },
  {
    ...
    description: "Mimo token-plan endpoint with 1M Opus/Sonnet model slots.",
  ...
  },
  {
    ...
    description: "Manually enter an Anthropic-compatible endpoint and optional model.",
    modelSummary: "Custom",
    tags: ["API", "Manual"],
    sortOrder: 90
  },
  {
    ...
    description: "CCR preset profile bound to openai,gpt-5.5.",
    modelSummary: "openai,gpt-5.5",
    tags: ["CCR", "GPT", "Router"],
    sortOrder: 40,
    ccrPreset: "ccr-gpt",
    ccrRoute: "openai,gpt-5.5",
  ...
  },
  {
    ...
    description: "Choose or type a CCR route manually.",
  ...
  },
  {
    ...
    description: "Create an isolated Claude Code account-login profile.",
...
export function listProfilePresets(): BuiltinProfilePreset[] {
  return PROFILE_PRESETS.map((preset) => ({ ...preset, ...(preset.type === "api" ? { env: { ...(preset as ApiProfilePreset).env } } : {}) }));
}
